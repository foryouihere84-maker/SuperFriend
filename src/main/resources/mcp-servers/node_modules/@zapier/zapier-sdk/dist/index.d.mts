...
interface ConnectionsPluginProvides {
    context: {
...
interface ListClientCredentialsPage {
    data: ClientCredentialsItem$1[];
    nextCursor?: string;
}

interface ListClientCredentialsPluginProvides {
    listClientCredentials: (options?: ListClientCredentialsOptions) => Promise<ListClientCredentialsPage> & AsyncIterable<ListClientCredentialsPage> & {
        items(): AsyncIterable<ClientCredentialsItem$1>;
    };
    context: {
        meta: {
...
interface CreateClientCredentialsPluginProvides {
...
interface DeleteClientCredentialsPluginProvides {
...
declare function runWithTelemetryContext<T>(fn: () => T): T;
...
declare const clientCredentialsNameResolver: StaticResolver;
 ...
 */
declare function invalidateCachedToken(clientId: string, scopes: string[]): void;
/**
